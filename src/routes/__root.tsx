    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6">
          <Link
            to="/"
            className="inline-flex items-center justify-center rounded-md bg-primary px-5 py-2.5 text-sm font-medium text-primary-foreground transition-colors hover:bg-accent"
          >
            Go home
          </Link>
        </div>
  ...
  head: () => ({
    meta: [
      ...
      { title: "Lantern Hill Advisory LLC | AI, Technology, and Operations Advisory" },
      {
        name: "description",
        content:
          "Lantern Hill Advisory helps organizations turn AI, technology, and operational goals into practical workflows, implementation plans, and adoption strategies.",
      },
      { name: "author", content: "Lantern Hill Advisory LLC" },
